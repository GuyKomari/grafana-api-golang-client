...
func (c *Client) GetCloudRegions(ctx context.Context) (CloudRegionsResponse, error) {
...
func (c *Client) GetCloudRegionBySlug(ctx context.Context, slug string) (CloudRegion, error) {
