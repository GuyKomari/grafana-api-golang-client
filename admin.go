...
func (c *Client) CreateUser(ctx context.Context, user User) (int64, error) {
	id := int64(0)
...
func (c *Client) UpdateUserPassword(ctx context.Context, id int64, password string) error {
...
func (c *Client) UpdateUserPermissions(ctx context.Context, id int64, isAdmin bool) error {
...
func (c *Client) PauseAllAlerts(ctx context.Context) (PauseAllAlertsResponse, error) {
