...
func (c *Client) GetServiceAccountPermissions(ctx context.Context, id int64) ([]*ServiceAccountPermission, error) {
...
func (c *Client) UpdateServiceAccountPermissions(ctx context.Context, id int64, items *ServiceAccountPermissionItems) error {
