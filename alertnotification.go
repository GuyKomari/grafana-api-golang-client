...
func (c *Client) AlertNotifications(ctx context.Context) ([]AlertNotification, error) {
...
// Deprecated: Grafana Legacy Alerting is deprecated as of 9.0 and will be removed in the future. Use ContactPoint instead.
func (c *Client) AlertNotification(ctx context.Context, id int64) (*AlertNotification, error) {
...
func (c *Client) NewAlertNotification(ctx context.Context, a *AlertNotification) (int64, error) {
...
func (c *Client) UpdateAlertNotification(ctx context.Context, a *AlertNotification) error {
...
func (c *Client) DeleteAlertNotification(ctx context.Context, id int64) error {
	path := fmt.Sprintf("/api/alert-notifications/%d", id)
