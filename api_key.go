...
func (c *Client) GetAPIKeys(ctx context.Context, includeExpired bool) ([]*GetAPIKeysResponse, error) {
...
func (c *Client) DeleteAPIKey(ctx context.Context, id int64) (DeleteAPIKeyResponse, error) {
